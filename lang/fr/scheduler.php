...
/**
 * Strings for component 'scheduler', language 'fr', version '4.1'.
 *
 * @package     scheduler
 * @category    string
...
$string['markseen'] = 'Après le rendez-vous avec un étudiant, veuillez le marquer comme « Terminé » en cochant la case adéquate dans le tableau ci-dessus.';
...
/** Update 2023/10/29 */
$string['scheduler:watchslots'] = 'Suivre les créneaux';
$string['event_slotunwatched'] = 'Créneau du gestionnaire non suivi';
$string['event_slotwatched'] = 'Créneau du gestionnaire suivi';
$string['messageprovider:watchedslotopenedup'] = 'Notification lorsqu\'un créneau suivi devient disponible';
$string['privacy:metadata:scheduler_watcher'] = 'Représente un étudiant qui suit un créneau';
$string['privacy:metadata:scheduler_watcher:userid'] = 'Étudiant qui suit le créneau';
$string['privacy:metadata:scheduler_watcher:slotid'] = 'Le créneau suivi';
$string['allowwatching'] = 'Autoriser le suivi';
$string['allowwatching_help'] = 'Lorsque le suivi est autorisé, les étudiants peuvent suivre les créneaux complets pour être notifiés lorsqu\'un rendez-vous devient disponible. Cependant, veuillez noter que le suivi n\'est pas possible lorsque l\'activité impose la réservation en groupe.';
$string['acceptlatebookings'] = 'Accepter les réservations tardives';
$string['acceptlatebookings_help'] = 'Lorsqu\'il est activé, les étudiants pourront réserver un créneau jusqu\'à l\'heure de fin.';
$string['alreadybookedbyyou'] = 'Ce créneau a déjà été réservé pour vous.';
$string['applyfilters'] = 'Appliquer les filtres';
$string['appointmentnotes'] = 'Notes de rendez-vous';
$string['bookingnotsupported'] = 'La réservation n\'est pas prise en charge, veuillez utiliser la version en ligne.';
$string['cancelfor'] = 'Annuler le rendez-vous pour';
$string['cannotcancelslot'] = 'Vous ne pouvez pas annuler le rendez-vous à ce moment.';
$string['cannotscheduleslotforothers'] = 'Vous ne pouvez pas planifier des rendez-vous pour d\'autres membres du personnel.';
$string['cannotwatchmoreslots'] = 'Vous ne pouvez pas suivre plus de créneaux pour le moment.';
$string['cannotwatchslot'] = 'Vous ne pouvez pas suivre ce créneau pour le moment.';
$string['choosegrouptobook'] = 'Veuillez sélectionner un groupe pour attribuer la réservation.';
$string['clearfilters'] = 'Effacer les filtres';
$string['completionattended'] = 'Exiger la présence';
$string['completionattended_desc'] = 'Les étudiants doivent être marqués comme présents';
$string['completionattended_help'] = 'Lorsqu\'il est activé, un étudiant doit être marqué comme ayant assisté à un rendez-vous pour que cette exigence soit satisfaite.';
$string['confirmsinglerevoke'] = 'Souhaitez-vous révoquer ce rendez-vous ?';
$string['couldnotresolveteacher'] = 'Impossible de résoudre l\'enseignant vers un compte utilisateur existant.';
$string['creditsrequiredtobookyouhavenone'] = 'Des crédits sont nécessaires pour réserver un créneau. Vous n\'en avez pas.';
$string['creditsrequiredtobookyouhavexuntilx'] = 'Des crédits sont nécessaires pour réserver un créneau. Vous avez {$a->count} crédits disponibles pour réserver des créneaux jusqu\'au {$a->latestdate}.';
$string['csvfile'] = 'Fichier CSV';
$string['csvline'] = 'Ligne';
$string['csvmissingcolumns'] = 'Les colonnes suivantes sont manquantes : {$a}.';
$string['emailreminder_help'] = 'Cela enverra un rappel par e-mail à l\'étudiant pour son prochain rendez-vous.';
$string['emailreminderondate_help'] = 'Cela enverra un rappel par e-mail à l\'étudiant pour son prochain rendez-vous.';
$string['errors'] = 'Erreurs';
$string['filterdatetimeafter'] = 'Après';
$string['filterdatetimeat'] = 'Ce jour à cette heure :';
$string['filterdatetimebefore'] = 'Avant';
$string['filterdatetimeon'] = 'Ce jour :';
$string['full'] = 'Complet';
$string['invalidorpastdate'] = 'La date n\'a pas pu être analysée ou est passée.';
$string['invalidteacher'] = 'Enseignant invalide fourni, il ne s\'agit pas d\'un enseignant.';
$string['import'] = 'Importer';
$string['importslots'] = 'Importer les créneaux';
$string['importslots_help'] = '
Les créneaux horaires peuvent être importés à partir d\'un fichier CSV, contenant les colonnes obligatoires suivantes :

- date : La date de début du créneau
- time : L\'heure à laquelle le créneau commence
- duration : La durée du créneau, en minutes

Les colonnes suivantes sont également prises en charge :

- maxstudents : Le nombre maximal d\'étudiants dans le créneau. Utilisez 1 pour exclusif, ou 0 pour illimité.
- location : L\'emplacement du rendez-vous.
- teacher : Le nom d\'utilisateur du compte Moodle de l\'enseignant. Une valeur vide correspond à l\'utilisateur actuel.
- displayfrom : La date à partir de laquelle le créneau sera visible.
- comment : Notes à attacher au créneau. Le format Markdown est pris en charge.

Les dates peuvent être exprimées dans l\'un de ces formats : MM/JJ/AAAA, AAAA-MM-JJ ou JJ-MM-AAAA. L\'heure peut être exprimée au format 12h ou 24h : 14h00 ou 2:00 PM.
';
$string['importslotsintro'] = 'Veuillez fournir un fichier CSV correspondant au format requis. Un exemple de fichier peut être téléchargé [ici]({$a->exampleurl}).';
$string['importallvalidslots'] = 'Importer tous les créneaux valides';
$string['maxslotswatched'] = 'Nombre maximum de créneaux surveillés';
$string['maxslotswatched_desc'] = 'Le nombre maximum de créneaux qu\'un étudiant peut surveiller par activité de planification. Lorsque défini à 0, les étudiants peuvent surveiller un nombre illimité de créneaux.';
$string['maxwatchers'] = 'Nombre maximum d\'observateurs';
$string['maxwatchers_desc'] = 'Le nombre maximum d\'étudiants autorisés à surveiller un créneau. Lorsque défini à 0, un nombre illimité d\'étudiants peut surveiller chaque créneau.';
$string['messageminchars'] = 'Nombre minimum de caractères pour le message';
$string['messageminchars_desc'] = 'Lorsque les étudiants sont tenus de saisir un message lors de la réservation, combien de caractères le message devrait-il contenir au minimum ? Augmenter cette valeur peut être utile lorsque les étudiants ignorent les exigences en matière de message en fournissant un seul caractère. Le nombre de caractères requis ne sera pas visible pour les étudiants.';
$string['mostrecentslots'] = 'Les créneaux les plus récents';
$string['negativetimerange'] = 'L\'heure de fin doit être postérieure à l\'heure de début.';
$string['noappointmentsyet'] = 'Vous n\'avez pas encore de rendez-vous dans ce planificateur.';
$string['noslotsavailableallbooked'] = 'Tous les créneaux sont actuellement complets. Aucun créneau n\'est prévu pour devenir disponible dans ce planificateur. Veuillez revenir plus tard ou contacter l\'équipe.';
$string['noslotsavailableallbookedseedate'] = 'Tous les créneaux sont actuellement complets. Des créneaux peuvent être libérés le {$a}.';
$string['nslotsimported'] = '{$a} créneau(x) importé(s)';
$string['nslotswitherror'] = '{$a} créneau(x) avec une erreur';
$string['purgeobsoletewatchers'] = 'Purger les observateurs obsolètes';
$string['recentandupcomingslots'] = 'Créneaux récents et à venir';
$string['requirecreditstobook'] = 'Exiger des crédits pour réserver';
$string['requirecreditstobook_help'] = 'Un étudiant doit dépenser des crédits pour réserver un rendez-vous. Cette option n\'est pas compatible avec les réservations de groupe.';
$string['results'] = 'Résultats';
$string['slottabcurrent'] = 'Actuels et futurs';
$string['slottabpast'] = 'Passés et terminés';
$string['filterstarttime'] = 'Date et heure';
$string['filterstarttime_help'] = 'Filtrer les créneaux selon la date et l\'heure. Cliquer sur "Appliquer les filtres" pour valider.';
$string['studentnotenoughcredits'] = 'L\'étudiant n\'a pas suffisamment de crédits pour prendre rendez-vous.';
$string['unwatchslot'] = 'Arrêter de surveiller le créneau';
$string['viewmoreoptions'] = 'Voir plus d\'options';
$string['visitwebtoaddnotes'] = 'Veuillez <a href="{$a}" core-link>visiter le site Web</a> pour ajouter des notes.';
$string['visitwebtobook'] = 'Visitez le site Web pour réserver ce créneau';
$string['visitwebtoeditcancel'] = 'Veuillez <a href="{$a}" core-link>visiter le site Web</a> si vous souhaitez apporter des modifications à la réservation.';
$string['visitwebtouploadfiles'] = 'Veuillez <a href="{$a}" core-link>visiter le site Web</a> pour joindre des fichiers à votre réservation.';
$string['watchslotsintro'] = 'Pour être averti lorsqu\'un créneau complet devient disponible, cliquez sur le bouton "Surveiller le créneau" pour ce créneau correspondant.';
$string['watchslotsintromax'] = 'Pour être averti lorsqu\'un créneau complet devient disponible, cliquez sur le bouton "Surveiller le créneau" pour ce créneau correspondant. Notez que vous ne pouvez pas surveiller plus de {$a} créneau(x) à la fois.';
$string['watchslot'] = 'Surveiller le créneau';
$string['email_slotopenedup_html'] = '<p>Un rendez-vous est devenu disponible pour un créneau le {$a->date} à {$a->time} avec le {$a->staffrole} {$a->attendant}.</p>';
$string['email_slotopenedup_plain'] = 'Un rendez-vous est devenu disponible pour un créneau le {$a->date} à {$a->time} avec le {$a->staffrole} {$a->attendant}.';
$string['email_slotopenedup_subject'] = '{$a->course_short} : Un créneau est devenu disponible';
$string['creditreasonslotbooked'] = 'Rendez-vous réservé : {$a->datetime} ({$a->minutes} min).';
$string['creditreasonslotcancelled'] = 'Rendez-vous annulé : {$a->datetime} ({$a->minutes} min).';
