...
$string['cannotdeleteselectioncontainsfuturebookedslots'] = 'The selection includes upcoming slots that have students booked onto them. **You cannot delete these without first Revoking the booking;** the student needs to be notified that the booking has been cancelled.';
$string['cannotdeleteslothasfuturebooked'] = 'This upcoming slot has students booked onto it. **You cannot delete it without first Revoking the booking;** the student needs to be notified that the booking has been cancelled.';
$string['confirmdeleteemptyslots'] = 'You are about to delete **{$a->nslots} empty or unused slot(s)**, are you sure?';
$string['confirmdeleteselectioncontainspastbookedslots'] = 'You are about to delete **{$a->nslots} slot(s)**, some of which have been booked or attended by students in the past. **All data will be lost if you delete these slots**. Are you sure?';
$string['confirmdeleteslot'] = 'Are you sure that you want to delete this slot?';
$string['confirmdeleteslothaspastbooked'] = 'You are about to delete a slot booked or attended by a student in the past. **All data will be lost if you delete this slot**. Are you sure?';
...
$string['cancelfor'] = 'Cancel appointment for';
...
$string['cannotcancelslot'] = 'You cannot cancel the appointment at this time.';
...
$string['cannotwatchslot'] = 'You cannot watch this slot at this time.';
...
$string['completiondetail:attended'] = 'Attend appointment';
...
$string['defaultsettings_desc'] = 'The settings that apply by default to new instances.';
...
$string['displayfrom_help'] = 'The date from which the slot will be visible to students. Note that the actual date may be slightly different from your chosen date due to the timing set by the administrator and your time zone.';
...
$string['emailreminder_help'] = 'This will send an email reminder to the student of their upcoming appointment.';
$string['emailreminderondate'] = 'Email a reminder on';
$string['emailreminderondate_help'] = 'This will send an email reminder to the student of their upcoming appointment.';
$string['end'] = 'End';
...
$string['hideuntiltime'] = 'Display from time';
$string['hideuntiltime_desc'] = "Sets the time of the day at which slots become visible to students. This time will be applied to the date chosen by teachers when creating their slots. Note that the time is applied in the server's default time zone.";
...
$string['maxwatchers'] = 'Maximum number of watchers';
$string['maxwatchers_desc'] = 'The maximum number of students allowed to watch a slot. When set to 0, an unlimited number of students can watch each slot.';
...
$string['messageminchars'] = 'Message minimum characters';
$string['messageminchars_desc'] = 'When students are required to enter a message during a booking, how many characters should the message contain at minimum? Increasing this can be useful when students _ignore_ the message requirements by providing a single character. The number of required characters will not be visible to students.';
...
$string['noslotsavailable'] = 'No slots are due to become available in this scheduler, please come back later, or contact the team.';
$string['noslotsavailableallbooked'] = 'All slots are currently fully booked. No slots are due to become available in this scheduler, please come back later, or contact the team.';
$string['noslotsavailableallbookedseedate'] = 'All slots are currently fully booked. Slots may be released on {$a}.';
...
$string['notesrequired'] = 'You must provide a message to book the slot.';
...
$string['slottabcurrent'] = 'Current & future';
$string['slottabpast'] = 'Past & seen';
